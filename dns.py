...
def read_xls(filename):
  ...
  di["X"]=array(sheet.col_values(8)[7:24])
  di["Y"]=array(sheet.col_values(9)[7:24])
  di["Z"]=array(sheet.col_values(7)[7:24])
  di["RotX"]=zeros(16)
  psi1=array(sheet.col_values(10)[7:24])
  psi2=array(sheet.col_values(11)[7:24])
  ...
  di["TUBE_PRESSURE"]=("tube_pressure",16.0,"atm")
  di["TUBE_TEMPERATURE"]=("tube_temperature",290.0,"K")
  #print di
  return di
  
if __name__=="__main__":
  filename='MLZ/DNS/dns_config.xls'
  ...
  det.addModerator("-2.29")# TODO: change moderator position to read from the excel sheet
  det.addSamplePosition()
  det.addComment("MONITORS")
  det.addMonitors(names=["monitor"],distance=["-0.20"])
  ...
  det.addComment("STANDARD 1.0m 960 PIXEL TUBE")
  det.addPixelatedTube("tube", info["NUM_PIXELS_PER_TUBE"], info["TUBE_SIZE"])
	
  det.addComment("PIXEL FOR STANDARD 1.0m 960 PIXEL TUBE")
